...
The reasons why I prefer indie softwares over unicorns are a plenty. In the Substack essay aptly as the [Tyranny of the Marginal User](https://nothinghuman.substack.com/p/the-tyranny-of-the-marginal-user), Ivan Vendrov talks about how for startups after reaching a definite scale, the product becomes satisfying for the new user, and gradually become terrible for the existing user.

Take the example of [OKcupid](https://www.okcupid.com/) which later on got acquired by Match, only to have a steady decline in the usage to the point that it became unusable.
...
_Wouldn’t neglecting the user experience of the existing users cause a loss?_
