...
Imagine you’re crafting a product for Michael Johnson, a fictional character representing the ‘average’ user: a 38-year-old IT project manager juggling work and family life. This approach, while seemingly comprehensive, inadvertently overlooks the diverse spectrum of users with unique needs and preferences. This is the essence of the ‘long tail problem’ as articulated by [Kasey Klimes](https://www.kaseyklimes.com/notes/2022/6/9/when-to-design-for-emergence). It states that focusing solely on the average user risks marginalizing those outside this central demographic. The product ends up serving the gaussian middle.

![](https://cdn.blot.im/blog_42f15db394c3417381df80148e1ec9e3/_image_cache/753529b1-bd68-45b7-8cff-7f6de176ac49.jpg)
...
_There is a way of addressing the long-tail problem, but it requires a very different paradigm for thinking about the way we design products, tools, and services. We can call this paradigm design for emergence. — Kasey Klimes, Design for emergence_
...
![Low floors: could make any object with the least number of pieces. High ceiling — you could even make Optimus Prime from Transformers if you really want to](https://cdn.blot.im/blog_42f15db394c3417381df80148e1ec9e3/_image_cache/58f6a5b7-f8f9-4477-8684-43e1c94e46b5.png)
...
![An example of how a sandwich is made composable](https://cdn.blot.im/blog_42f15db394c3417381df80148e1ec9e3/_image_cache/b38000ad-5cf7-4178-9f49-cc5840ab7ae7.png)
...
![Taking Notion for example, where a document processor becomes infinitely composable through infinite ‘content blocks’.](https://cdn.blot.im/blog_42f15db394c3417381df80148e1ec9e3/_image_cache/8c2cf683-909e-40a7-9ed9-740f180ee1b4.jpg)
...
![Arc makes browsers infinitely composable by providing users the ability to make multiple workspaces and customising it the way they want. They even go further providing art tools to even choose the font and styling of the user’s apps](https://cdn.blot.im/blog_42f15db394c3417381df80148e1ec9e3/_image_cache/0504fae0-a39f-400c-b31f-6d3137212502.png)
...
When we, or in some cases I — as the head chef of the omakase experience that is Rails — decide to include a dish, it’s usually based on our distilled tastes and preferences. I’ve worked in this establishment for a decade. I’ve poured well in the excess of ten thousand hours into Rails. This doesn’t make my tastes right for you, but it certainly means that they’re well formed. —_ [_DHH on this blog._](https://dhh.dk/)
...
> [pic.twitter.com/DsmisqDGSp](https://t.co/DsmisqDGSp)
> 
> — Elon Musk (@elonmusk) [January 3, 2024](https://twitter.com/elonmusk/status/1742405058690457971?ref_src=twsrc%5Etfw)
