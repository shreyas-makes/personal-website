...
I would start by asking these key questions to the product leadership team—_What does the future state look like? — Vision. What are we trying to achieve? — Mission. What's our plan to win? —Strategy. How are we measuring progress towards the strategy? — Goals. What are we building to realise the vision? - Roadmap._ Once these fundamentals are covered, I would work my way up from there.
