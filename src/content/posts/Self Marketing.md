...
description: >-
  _I decided to revive a long-lost interest and try my hand at cartooning. But
  it was an unlikely dream, given my complete lack of artistic talent and the
  rarity of success stories in that business. So...
...
This was when I was wondering if the power of marketing could be turned upside down. Towards yourself? Let me explain in a bit with my own use case.

![[Attachments/images/2024/11/image.png]]

  
  
(Get up) - (Read Books) - (Take a shower) - (Phone calls) - (Eat Breakfast)

_How boring does this all sound?_ Half way through I lose all my excitement towards the day and end up not doing anything at all.

**Now how about I use the same language which you get to see in advertisements?**

(_Get up_) becomes (_Rise and Shine!_), )_Read Book_) becomes (_Enjoy a book_), (_Finish report_) becomes (_Get to see a completed report!_). And so on..

![[Attachments/images/2024/11/image-2.png]]

**Framing** is a very powerful weapon used in various places directly or indirectly. Words pop up images in your mind. Different words pop different images. It's as simple as that. The image which pops up when I say 'climate change' is very different from the image which pops us when I say 'global warming', even though both essentially mean the same. (This article, [Why It Matters How We Frame The Environment](https://www.tandfonline.com/doi/full/10.1080/17524030903529749) by Geoge Lakoff talks about this in deep)

![[Attachments/images/2024/11/image-3.png]]
