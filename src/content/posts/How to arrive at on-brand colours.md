...
An important point to note here: [psychographic profile](https://mailchimp.com/resources/psychographic-segmentation-examples/#:~:text=Psychographic%20examples%20include%20grouping%20customers,campaigns%20geared%20toward%20those%20individuals) is very different from the demographic profile. You are not as keen on understanding the age, country of origin, activities etc, but on a deeper front taking a peak into their psyche: their motivations, needs and aspirations.
...
You can also start looking for colour palettes in isolation, but you might miss out on the context in which the palette was formulated. To get a sense of the context while ALSO exploring the colors, I use [Happy Hues](https://www.happyhues.co/) for this purpose.
...
1.  Unity: Choose a boring, dull color for 70% of the product, which will be used for backgrounds. This color should provide a sense of consistency and cohesion throughout the UI.[1](__GHOST_URL__/how-to-arrive-at-on-brand-colors#footnote-1CTJ)
...
[I use this tool](http://cymbolism.com/words) to arrive at the appropriate color for the emotion.
